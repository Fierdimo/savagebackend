...
class Orders(models.Model):
    ...
    user_id = models.CharField(help_text='Identificación del usuario', blank=True, max_length=36 )
    user_alternate_id = models.CharField(help_text='Identificacion usuario no registrado', max_length=50)  
    delivery_id = models.CharField(help_text='Identificación del usuario', blank=True, max_length=36)
    ...
    address = models.CharField(help_text='Direccion de envío', max_length=150, default='')
